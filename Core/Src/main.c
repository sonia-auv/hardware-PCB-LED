...
/* Definitions for AllumageLED */
osThreadId_t AllumageLEDHandle;
const osThreadAttr_t AllumageLED_attributes = {
  .name = "AllumageLED",
  .stack_size = 256 * 4,
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  /*
	 ws2812bSetRGB(&ledStrip,0,255,255,255);
	 ws2812bSetRGB(&ledStrip,1,255,0,0);
	 ws2812bSetRGB(&ledStrip,2,255,255,0);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, ledtest_Pin|RS485_RE_Pin|RS485_DE_Pin|RS485_TE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_RESET);

  /*Configure GPIO pins : ledtest_Pin RS485_RE_Pin RS485_DE_Pin RS485_TE_Pin */
  GPIO_InitStruct.Pin = ledtest_Pin|RS485_RE_Pin|RS485_DE_Pin|RS485_TE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : signalkill_Pin */
  GPIO_InitStruct.Pin = signalkill_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(signalkill_GPIO_Port, &GPIO_InitStruct);
...
/**
  * @brief  Function implementing the AllumageLED thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_Allumage_LED */
void Allumage_LED(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
...
/**
* @brief Function implementing the RecoisTrans thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Recois_Trans */
void Recois_Trans(void *argument)
{
  /* USER CODE BEGIN Recois_Trans */
  /* Infinite loop */
  for(;;)
  {
#define R 0;
